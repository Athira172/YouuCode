...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container">
      <div class="header-container d-flex align-items-center justify-content-between">
        <div class="logo">
          <h1 class="text-light"><a href="index.html"><span>YouCode</span></a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>Your New Online Presence with YouCode</h1>
  ...
  <main id="main">
            ...
            <div class="row">
              ...
              <div class="col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200">
                  ...
                  <h4><a href="qrcode.php">Generate QR Code</a></h4>
    ...
    <!-- ======= Login Section ======= -->
    <section id="portfolio" class="ftco-section contact-section">
      <div class="col-lg-4">
        <div class="section-title" data-aos="fade-right">
          <h2 style="margin-left: 145%;">Login</h2>
      ...
      <div class="container">
        ...
        <div class="row block-9 no-gutters">
          <div class="col-lg-6 order-md-last d-flex">
            <form action="loginaction.php" method="post" onsubmit="return check();" class="bg-light p-5 contact-form">
    ...
    <!-- ======= Register Section ======= -->
    <section id="team" class="ftco-section contact-section">
      <div class="col-lg-4">
        <div class="section-title" data-aos="fade-right">
          <h2 style="margin-left: 145%;">Register</h2>
      ...
      <div class="container" >
        ...
        <div class="row block-9 no-gutters">
          <div class="col-lg-6 order-md-last d-flex">
            <form action="useraction.php" method="post" onsubmit="return check();" class="bg-light p-5 contact-form">
              <div class="form-group">
                <input type="text" name="name" class="form-control" require id="name" placeholder="Your Name">
              </div>
              <div class="form-group">
                <input type="text" name="email" class="form-control" required placeholder="Your Email">
              </div>
